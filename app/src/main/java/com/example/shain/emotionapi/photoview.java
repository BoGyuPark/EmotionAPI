...
public class photoview extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_back.setOnClickListener(photoview.this);
    ...
    private void requestPermission() {
        ActivityCompat.requestPermissions(photoview.this, new String[]{READ_EXTERNAL_STORAGE}, REQUEST_PERMISSION_CODE);
    }
    ...
    private class GetEmotionCall extends AsyncTask<Void, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                //결과값 intent로 보내기 // preference로 저장하기
                Intent myIntent = new Intent(photoview.this, ReadActivity.class);
